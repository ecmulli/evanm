...
export default function MenuDropdown({ label, items, bold }: MenuDropdownProps) {
  ...
  return (
    <div ref={menuRef} className="relative">
      <button
        ...
        onMouseEnter={() => {
          // If any menu is open, open this one on hover
          const anyMenuOpen = document.querySelector('.retro-dropdown-open');
          if (anyMenuOpen) {
            setIsOpen(true);
          }
        }}
      ...
      {isOpen && (
        <div className={`retro-dropdown-open absolute top-full left-0 mt-0 min-w-[180px] bg-[#F5F0EB] border-2 border-[#3A3530] shadow-[2px_2px_0_#3A3530] z-[10000]`}>
