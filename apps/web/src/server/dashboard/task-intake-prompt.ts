 ...
 * for the unified Notion database.
 */
...
## Unified Task Database

All tasks go into a single database. The user selects a Domain (Work, Career, Personal) — always use that domain. Focus on extracting the best properties for the task.

### Properties
- "Name" (title): Clear, concise task title extracted from the input
...
- **Career**: LinkedIn content, networking, job search, portfolio, personal branding, thought leadership
- **Personal**: household, finance, family, health, home repairs, errands
